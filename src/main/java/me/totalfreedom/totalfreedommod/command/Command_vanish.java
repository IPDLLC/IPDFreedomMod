    ...
    public boolean run(final CommandSender sender, final Player playerSender, final Command cmd, final String commandLabel, final String[] args, final boolean senderIsConsole)
    {
        ...
        if (VANISHED.contains(playerSender))
        {
            ...
            if (!silent)
            {
                ...
                FUtil.bcastMsg(playerSender.getName() + " joined.", ChatColor.YELLOW);
            }
        ...
        else
        {
            ...
            if (!silent)
            {
                FUtil.bcastMsg(playerSender.getName() + " left.", ChatColor.YELLOW);
            }
            ...
            {
                {
                    ...
                    playerMsg(player, ChatColor.GREEN + "[Vanish] " + sender.getName() + " has vanished and is only visible to MOD and higher" );
                    if (!plugin.al.isAdmin(player))
