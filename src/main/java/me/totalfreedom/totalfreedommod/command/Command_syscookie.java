...
public class Command_syscookie extends FreedomCommand
{
    public static final String COOKIE_LYRICS = "Hey, don't cry that you don't have friends! A system admin is here to give you a cookie! \nImagine that you have zero cookies and you split them evenly among zero friends. How many cookies does each person get? See? It doesn't make sense. And Cookie Monster is sad that there are no cookies, and you are sad that you have no friends.";
    public static final String LORE = "Hey, don't cry that you don't have friends! A system admin is here to give you a cookie!";
