...
<<<<<<< HEAD
    ...
    DISCORD_MODERATOR_ROLE_ID(String.class, "discord.moderator_role_id"),
    DISCORD_SUPER_ROLE_ID(String.class, "discord.super_role_id"),
    DISCORD_TELNET_ROLE_ID(String.class, "discord.telnet_role_id"),
    DISCORD_TELNET_CLAN_ROLE_ID(String.class, "discord.telnet_clan_role_id"),
    DISCORD_SENIOR_ROLE_ID(String.class, "discord.senior_role_id"),
    DISCORD_SYSTEM_ADMIN_ROLE_ID(String.class, "discord.system_admin_role_id"),
    //
